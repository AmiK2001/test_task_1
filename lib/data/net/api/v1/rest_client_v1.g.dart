...
class _RestClientV1 implements RestClientV1 {
  ...
  Future<AuthorizationResponseDto> authorization(
      AuthorizationRequestDto request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{
      r'Content-Type': 'application/json',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<AuthorizationResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json',
    ...
    final value = AuthorizationResponseDto.fromJson(_result.data!);
    return value;
  }
  ...
  Future<RegistrationResponseDto> registration(
    ...
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RegistrationResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json',
    ...
    final value = RegistrationResponseDto.fromJson(_result.data!);
    return value;
  }
  ...
  Future<RefreshTokenResponseDto> refreshToken(
    ...
    _data.addAll(request.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RefreshTokenResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
      contentType: 'application/json',
    ...
    final value = RefreshTokenResponseDto.fromJson(_result.data!);
    return value;
  }
